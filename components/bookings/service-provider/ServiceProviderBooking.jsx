...
const ServiceProviderBooking = ({ booking }) => {
  ...
  useEffect(() => {
    const gettingServiceProviderBookings = async () => {
      try {
        const newBookings = booking.filter(
          (order) => !order.completed && !order.canceledByCustomer
        );
        const completedBookings = booking.filter(
          (order) => order.completed
        );
        const canceledBookings = booking.filter(
          (order) => order.canceledByCustomer
        );
  ...
  }, [user, selectedNewBooking, booking]);
        ...
        <div className="container mx-auto py-8 px-4 lg:px-0">
          ...
          >
            <DialogHeader className="flex justify-between items-center p-0 mb-2 px-4">
              ...
              <IconButton variant="text" onClick={handleOpenNewBookingDialog}>
                <RxCross1 size={20} />
              </IconButton>
            </DialogHeader>
                    ...
                    <div className="flex gap-4 flex-col md:flex-row items-center justify-center">
                      <div className="flex justify-center">
                        <Image
                          ...
                          height={100}
                          src={
                            selectedCompletedBooking?.verificationImage?.url ||
