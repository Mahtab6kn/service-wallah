  ...
  const handleCancelBooking = async () => {
    try {
      ...
      if (response.status === 201) {
        ...
        setUserBookings(
          userBookings.filter(
            (booking) => booking._id !== selectedUserBooking._id
          )
        );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 ">
            {userBookings.map((service, index) => {
              return (
                ...
                >
                  {service?.acceptedByServiceProvider ? (
                    <div className="bg-teal-100 text-teal-500 py-1 flex justify-center items-center uppercase">
                      booking Accepted
                    </div>
                  ) : (
                    <div className="bg-red-100 text-red-500 py-1 flex justify-center items-center uppercase">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <div className="flex flex-col gap-4 mb-2">
                          ...
                          >
                            <Option value="My schedule has changed, and I no longer need the service.">
                              My schedule has changed, and I no longer need the
                              service.
                            </Option>
                            <Option value="I found another provider that better fits my needs.">
                              I found another provider that better fits my
                              needs.
                            </Option>
                            ...
                            <Option value="The service provider is unavailable at the desired time.">
                              The service provider is unavailable at the desired
                              time.
                            </Option>
