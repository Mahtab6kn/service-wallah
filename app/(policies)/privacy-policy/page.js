...
const Page = () => {
  return (
    <div className="p-6 lg:px-32 lg:py-16">
      <h1 className="text-4xl font-bold mb-4 text-pink-600">Privacy Policy</h1>
      <p className="text-sm mb-2 text-gray-500">Last updated: July 31, 2024</p>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-pink-600">
      ...
      <h3 className="text-xl font-semibold mb-2 text-pink-600">Definitions</h3>
      <p className="mb-4 text-gray-700">
      ...
      <h4 className="text-lg font-semibold mb-2 text-pink-600">
        Personal Data
      </h4>
      <p className="mb-4 text-gray-700">
      ...
      <h4 className="text-lg font-semibold mb-2 text-pink-600">Usage Data</h4>
      <p className="mb-4 text-gray-700">
      ...
      <ul className="list-disc list-inside mb-4 text-gray-700">
        ...
        <li className="mb-2">
          ...
          that are similar to those that you have already purchased or inquired
      ...
      <p className="mb-4 text-gray-700">
        The Company will take all the steps reasonably necessary to ensure that
